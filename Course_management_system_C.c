// Creating a menu for student management
#include <math.h> 
#include <stdio.h> 
#include <stdlib.h> 
#include <string.h> 
...
// Finding students by their roll number 
void find_rl() 
{ 
    int x; 
...
// Finding students by their first name
void find_fn() 
{ 
    char a[50]; 
...
// Finding if the students are in a particular class or not
void find_c() 
{ 
    int id; 
